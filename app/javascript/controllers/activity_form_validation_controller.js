...
const TITLE_PATTERN = /^[a-zA-Z0-9][a-zA-Z0-9\s.\-'&,!?():;\/+]*$/
const LOCATION_PATTERN = /^[a-zA-Z0-9][a-zA-Z0-9\s.,#'\-\/&():]*$/
const SQL_LIKE_PATTERN = /\b(select|insert|update|delete|drop|union|alter|create|truncate)\b[\s\S]{0,80}?\b(from|into|table|database)\b/i
